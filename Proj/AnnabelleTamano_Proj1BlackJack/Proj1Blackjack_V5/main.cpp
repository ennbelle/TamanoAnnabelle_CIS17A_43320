 ...
 * Created on May 16, 2021, 12:50 PM
 * Purpose: This Project simulates a single player game of Blackjack. (Version 5)
 ...
 *          -Plays with setSB and seeSB Functions to mess with binary files
 */
...
void seeSB() {
    ...
    //Declare and Initialize Variables
    fstream fl;   //file
    fl.open("sb.bin",ios::in|ios::out|ios::binary);
    User* sb=new User[5];
