 ...
 * Created on May 10, 2021, 3:36 PM
 * Purpose: This Project simulates a single player game of Blackjack. (Version 4)
 ...
 *            creates array of struct Card, runs a working game of Blackjack
 *          - Stores name, mWon, and gPlyd information in User struct
 */
...
void setSB(User &); //Update Scoreboard
...
//******************************************************************************
void setSB(User& plyr) {
    cout<<"Setting Scoreboard...\n\n";
}
